  ...
  return (
    <>
      ...
      <Tab.Group onChange={(index) => handleSelectedTab(index)}>
        ...
        <Tab.Panels>
          <Tab.Panel>
            {/* this remove identityCreditCard input */}
          </Tab.Panel>
          ...
          <div className='flex flex-col'>
            <div className="inline-block relative">
              <select
                ...
                className="block appearance-none w-full border-2 border-gray-200 outline-gray-400 rounded bg-gray-200 text-gray-700 placeholder-gray-500 focus:outline-none focus:bg-white focus:border-orange-500 p-2 pr-8 mb-1">
